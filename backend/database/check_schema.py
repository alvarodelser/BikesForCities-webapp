...
EXPECTED_COLUMNS = [
    ...
    ("city_modes",    "gcc_fraction",    "double precision"),
    ("city_modes",    "gcc_km",          "double precision"),
    ("city_modes",    "total_cycling_km","double precision"),
    ("city_modes",    "n_components",    "integer"),
    ("edges",         "building_count",  "integer"),
    ("edges",         "component_id",    "integer"),
    ("features",      "component_id",    "integer"),
    ("stations",      "building_coverage", "double precision"),
